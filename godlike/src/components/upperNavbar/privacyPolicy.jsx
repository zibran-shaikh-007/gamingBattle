                    ...
                    <div className="nk-header-table">
                        <div className="nk-header-table-cell">
                            <div className="container">
                                <h1 className="nk-title">PRIVACY POLICY</h1>
                            </div>
                        </div>
                    </div>
                </div>
...
If you have any questions or concerns regarding this privacy policy, you should contact our Customer Support Desk at support@gamingbattle.com
...
c. “Website” shall mean and refer to GamingMonk created by the Company
...
In order to access the tournaments or portal on this Website, you are required to provide the following information which includes, but is not limited to:
...
Gamertags;
Location; and
any other permission or information required.
